...
export default function LogoutModal() {
   ...
   const { isPending, execute } = useAction(logoutAction, {
      ...
      onError(err) {
         toast.error('Oops !', {
            description: err.error.serverError || 'Une erreur est survenue.',
            duration: 6000,
         })
         closeModal()
      },
   ...
   return (
      <AlertDialog open={isVisible}>
         <AlertDialogContent className='sm:max-w-[425px]'>
            ...
            <p className='text-base text-muted-foreground text-center mb-4'>Voulez-vous vraiment vous déconnecter ?</p>
