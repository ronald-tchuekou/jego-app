...
export const updateEmailSchema = z.object({
	...
	password: z
		.string()
		.min(1, 'Le mot de passe actuel est requis pour changer l\'email'),
})
...
export const verifyEmailChangeSchema = z.object({
	verificationCode: z
		.string()
		.min(6, 'Le code de vérification doit contenir 6 caractères')
		.max(6, 'Le code de vérification doit contenir 6 caractères'),
})
